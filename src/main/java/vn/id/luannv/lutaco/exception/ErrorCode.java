...
public enum ErrorCode {
    ...
    UNSUPPORTED_YET("unsupported.yet", HttpStatus.BAD_REQUEST),
    ...
    INVALID_PARAMS("invalid.param", HttpStatus.BAD_REQUEST), JOB_INTERRUPTED("job.interrupted", HttpStatus.BAD_REQUEST);
    String message;
