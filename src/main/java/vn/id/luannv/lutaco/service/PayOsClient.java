...
public class PayOsClient {
    ...
    public PayOSResponse<PayOSResponse.PayOSDataDetail> getDetail(Integer id) {
    ...
    private PayOSResponse<PayOSResponse.PayOSDataDetail> getDetailExecute(Integer id) {
    ...
    public List<PayOSResponse.PayOSDataByUser> getBySelf(Long userId) {
        return payOSRepository.findByUserId(userId).stream()
                .map(payOS -> PayOSResponse.PayOSDataByUser.builder()
                        .orderCode(payOS.getOrderCode())
                        .amount(payOS.getAmount())
