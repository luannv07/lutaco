...
public class RecurringTransactionController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<BaseResponse<RecurringTransactionResponse>> update(
    ...
    public ResponseEntity<BaseResponse<Void>> toggle(@PathVariable Long id) {
        recurringTransactionService.toggle(id);
        return ResponseEntity.ok(BaseResponse.success("Thay đổi trạng thái giao dịch định kỳ thành công."));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<BaseResponse<Void>> delete(@PathVariable Long id) {
        recurringTransactionService.deleteById(id);
        return ResponseEntity.ok(BaseResponse.success("Xoá giao dịch định kỳ thành công."));
    }

    @GetMapping("/{id}")
    public ResponseEntity<BaseResponse<RecurringTransactionResponse>> getDetail(@PathVariable Long id) {
        return ResponseEntity.ok(
                BaseResponse.success(
    ...
    @GetMapping
    public ResponseEntity<BaseResponse<List<RecurringTransactionResponse>>> getMyRecurring() {
        return ResponseEntity.ok(
                BaseResponse.success(
                        recurringTransactionService.getMyRecurring(),
